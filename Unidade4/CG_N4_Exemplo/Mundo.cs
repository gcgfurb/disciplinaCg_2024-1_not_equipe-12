...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    private Objeto cuboMenor;
    private Camera _camera;
    private Texture _texture;
    private double _anguloOrbita;
    ...
    protected override void OnLoad()
    {
      ...
      #region Objeto: ponto  
      cuboMenor = new Ponto(mundo, ref rotuloNovo, new Ponto4D(2.0, 0.0));
      ...
      #region Objeto: Cubo
      cuboMaior = new Cubo(mundo, ref rotuloNovo);
      #endregion
    ...
    protected override void OnUpdateFrame(FrameEventArgs e)
    {
      ...
      _anguloOrbita += 0.01;
      if (_anguloOrbita > 2 * Math.PI)
      {
          _anguloOrbita -= 2 * Math.PI;
      }

      float x = (float)(2.0f * Math.Cos(_anguloOrbita)) - (float)(2.0f * Math.Cos(_anguloOrbita - 0.01));
      float y = (float)(2.0f * Math.Sin(_anguloOrbita)) - (float)(2.0f * Math.Sin(_anguloOrbita - 0.01));

      cuboMenor.MatrizTranslacaoXYZ(x, y, 0.0f);
